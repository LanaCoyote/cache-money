...
// converts an arguments keyword from an array-like object to a usable array. we
// use a for loop because slicing is unoptimized in v8.
//
// param: args - the arguments keyword to convert
//
// returns: an array from an array-like object
...
//
// returns: a cachedFunction that keeps track of its previous calls
...
LocalCache.prototype = Object.create( Function.prototype );
...
// METHOD: LocalCache.prototype.toString
// returns a stringified version of the LocalCache function
//
// returns: {LocalCache of <fn>, previous calls:{
//              (<arguments>) => <result>,
//          }}
...
if ( module && !window ) module.exports = Cache$;